      ...
      <div>
        <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
          ...
          <div className="flex justify-center items-center">
            <button className="focus:outline-none focus:ring-2 focus:ring-offset-2  transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-4 sm:px-10 py-2 sm:py-4 text-sm">
              Admin
            </button>
            <Link
              to="/employee"
